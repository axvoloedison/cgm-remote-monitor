...
function init() {
  ...
  var translations = {
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, MAKE SURE IOB IS COVERED BY CARBS' : {
      ...
      ,ru: 'Избыток инсулина, равного %1U, необходимого для достижения нижнего целевого значения, ПОКРОЙТЕ АКТИВНЫЙ ИНСУЛИН В ОРГАНИЗМЕ УГЛЕВОДАМИ'
    ...
    ,'%1U reduction needed in active insulin to reach low target, too much basal?' : {
      ...
      ,ru: 'Для достижения нижнего целевого значения необходимо понизить величину активного инсулина на %1U, слишком большой базал?'
    ...
    ,'Basal reduction to account %1 units:' : {
      ...
      ,ru: 'Снижение базала на %1 единиц'
    ...
    ,'Cannula change overdue!' : {
      ...
      ,ru: 'Просрочено время замены канюли'
   ...
   ,'Last Carbs' : {
    ...
    ,'Sensor change/restart overdue!' : {
      ...
      ,ru: 'Замена/рестарт сенсора просрочена'
